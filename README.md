...
| [airflow](./src/airflow-service)           | Flask/Python & MongoDB | This contains apache airflow, an open-source workflow management platform for data
...
| [gp-model](./src/gp-model) .     | Python & MongoDB                |This is mainly used in spatial temporal modelling works                                                                                                                           |
