...
class ProductionConfig(Config):
    ...
    MLFLOW_TRACKING_URI = os.getenv('MLFLOW_TRACKING_URI_PROD')
    MLFLOW_TRACKING_PORT = os.getenv('MLFLOW_TRACKING_PROT_PROD')
...
class TestingConfig(Config):
    ...
    MLFLOW_TRACKING_URI = os.getenv('MLFLOW_TRACKING_URI_STAGE')
    MLFLOW_TRACKING_PORT = os.getenv('MLFLOW_TRACKING_PROT_STAGE')
    MLFLOW_TRACKING_USERNAME = os.getenv('MLFLOW_TRACKING_USERNAME_STAGE')
    MLFLOW_TRACKING_PASSWORD = os.getenv('MLFLOW_TRACKING_PASSWORD_STAGE')
...
class DevelopmentConfig(Config):
    ...
    MLFLOW_TRACKING_PORT = os.getenv('MLFLOW_TRACKING_PROT_DEV')
