                            ...
                            <table style="width: 100%;">
                                ...
                                <tr>
                                    <td
                                        ...
                                        Welcome to AirQo Analytics 🎉
                                        <br />
                                        Thank you for choosing AirQo Mobile! To securely log in to your account, please use the following 5-digit code:
                                        <br /><br />
                                        ...
                                        <table style="width: 100%; text-align: center;">
                                            <tr>
                                                <td>
                                                    <div
                                                        style="width: fit-content; height: 100%; padding-left: 32px; padding-right: 32px; padding-top: 16px; padding-bottom: 16px; background: #135DFF; border-radius: 1px; justify-content: center; align-items: center; gap: 10px; display: inline-flex">
                                                        <div
                                                            style="text-align: center; color: white; font-size: 24px; font-family: Inter; font-weight: 600; line-height: 30px; word-wrap: break-word">
                                                            ${token}</div>
                                                    </div>
                                                </td>
                                            </tr>
