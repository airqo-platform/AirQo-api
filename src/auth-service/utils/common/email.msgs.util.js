  ...
  tokenExpired: ({
    ...
    <tr>
      <td style="color: #344054; font-size: 16px; font-family: Inter; font-weight: 400; line-height: 24px; word-wrap: break-word;">
        ...
        ${expiryLine}
        <p>To continue accessing our services, you can refresh your token directly — no need to create a new API client. Simply log in to <a href="${constants.LOGIN_PAGE}">AirQo Analytics</a>, go to <a href="${constants.ANALYTICS_BASE_URL}/user/profile?tab=api">your API settings</a>, and regenerate your token from your existing client.</p>
        <p>If you are using the AirQo mobile app, you can manage your API token settings directly within the app.</p>
        ${securityTip}
      </td>
    </tr>
    ...
    const content = `
      <tr>
        <td style="color: #344054; font-size: 16px; font-family: Inter; font-weight: 400; line-height: 24px; word-wrap: break-word;">
          ...
          ${tokenCallout}
          ${expiryLine}
          <p>To regenerate, log in to <a href="${constants.LOGIN_PAGE}">AirQo Analytics</a>, go to <a href="${constants.ANALYTICS_BASE_URL}/user/profile?tab=api">your API settings</a>, and regenerate your token from your existing client — no need to create a new one.</p>
          <p>If you are using the AirQo mobile app, you can manage your API token settings directly within the app.</p>
  ...
  tokenAutoSuspended: ({
    ...
    <tr>
      <td style="color: #344054; font-size: 16px; font-family: Inter; font-weight: 400; line-height: 24px; word-wrap: break-word;">
        ...
        <p style="margin-top:16px; padding:12px; background:#F0F4FF; border-left:4px solid #4A6CF7; border-radius:4px;"><strong>Security tip:</strong> To reduce the chance of this happening again, consider enabling the client secret requirement for your API client under <a href="${API_SETTINGS_URL}"><strong>your API settings</strong></a>. When enabled, every request must include your client secret via the <code>X-Client-Secret</code> header, providing an extra layer of protection even if your token is exposed.</p>
