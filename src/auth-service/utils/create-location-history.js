...
const LocationHistoryModel = (tenant) => {
    try {
        ...
        let locationHistories = getModelByTenant(tenant, "locationHistory", LocationHistorySchema);
        return locationHistories;
    }
};
...
const locationHistories = {
    ...
    list: async (request) => {
        try {
            ...
            const responseFromListLocationHistories = await responseFromListLocationHistoriesPromise;
    ...
    syncLocationHistories: async (request) => {
        ...
        try {
            ...
            let unsynced_location_histories = (await LocationHistoryModel(
                tenant.toLowerCase()
            ).list({ filter })).data;
