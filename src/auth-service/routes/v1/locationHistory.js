    ...
    oneOf([
        [
            body("location_histories")
                ...
                .withMessage("Invalid request body format. The location_histories should be an array"),
            body("location_histories.*")
                .optional()
                .isObject()
            ...
            body("location_histories.*.firebase_user_id")
                .exists()
                .withMessage("the firebase_user_id is missing in the location history object")
                .bail()
                .notEmpty()
                .withMessage("the firebase_user_id must not be empty")
                .bail()
