...
const createSearchHistory = {
  syncSearchHistory: async (req, res, next) => {
    try {
      ...
      const result = await searchHistoryUtil.syncSearchHistories(request, next);
  ...
  create: async (req, res, next) => {
    try {
      ...
      const result = await searchHistoryUtil.create(request, next);
  ...
  list: async (req, res, next) => {
    try {
      ...
      const result = await searchHistoryUtil.list(request, next);
  ...
  delete: async (req, res, next) => {
    try {
      ...
      const result = await searchHistoryUtil.delete(request, next);
  ...
  update: async (req, res, next) => {
    try {
      ...
      const result = await searchHistoryUtil.update(request, next);
