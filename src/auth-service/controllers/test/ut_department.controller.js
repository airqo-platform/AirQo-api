  ...
  describe("list()", () => {
    it("should list departments successfully", async () => {
      ...
      const validationResultStub = sinon
        ...
        .returns(true);
      const departmentUtilStub = sinon
        .stub(departmentUtil, "listDepartment")
        .resolves({
          success: true,
      ...
      expect(departmentUtilStub.calledOnceWith(req)).to.be.true;
  ...
  describe("create()", () => {
    ...
    it("should create a department successfully", async () => {
      ...
      const validationResultStub = sinon
        ...
        .returns(true);
      const departmentUtilStub = sinon
        .stub(departmentUtil, "createDepartment")
        .resolves({
          success: true,
          status: httpStatus.OK,
  ...
  describe("update()", () => {
    ...
    it("should update a department successfully", async () => {
      ...
      const validationResultStub = sinon
        ...
        .returns(true);
      const departmentUtilStub = sinon
        .stub(departmentUtil, "updateDepartment")
        .resolves({
          success: true,
          status: httpStatus.OK,
  ...
  describe(" delete()", () => {
    ...
    it("should delete a department successfully", async () => {
      ...
      const validationResultStub = sinon
        ...
        .returns(true);
      const departmentUtilStub = sinon
        .stub(departmentUtil, "deleteDepartment")
        .resolves({
          success: true,
          status: httpStatus.OK,
  ...
  describe("listUsersWithDepartment()", () => {
    ...
    it("should list users with department successfully", async () => {
      ...
      const validationResultStub = sinon
        ...
        .returns(true);
      const departmentUtilStub = sinon
        .stub(departmentUtil, "listUsersWithDepartment")
        .resolves({
          success: true,
          status: httpStatus.OK,
  ...
  describe("listAvailableUsersForDepartment()", () => {
    ...
    it("should list available users for department successfully", async () => {
      ...
      const validationResultStub = sinon
        ...
        .returns(true);
      const departmentUtilStub = sinon
        .stub(departmentUtil, "listAvailableUsersForDepartment")
        .resolves({
          success: true,
          status: httpStatus.OK,
  ...
  describe("assignUserToDepartment()", () => {
    ...
    it("should assign user to department successfully", async () => {
      ...
      const validationResultStub = sinon
        ...
        .returns(true);
      const departmentUtilStub = sinon
        .stub(departmentUtil, "assignUserToDepartment")
        .resolves({
          success: true,
          status: httpStatus.OK,
  ...
  describe("unAssignUserFromDepartment()", () => {
    ...
    it("should unassign user from department successfully", async () => {
      ...
      const validationResultStub = sinon
        ...
        .returns(true);
      const departmentUtilStub = sinon
        .stub(departmentUtil, "unAssignUserFromDepartment")
        .resolves({
          success: true,
          status: httpStatus.OK,
