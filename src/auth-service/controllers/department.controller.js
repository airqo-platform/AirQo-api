...
const createDepartment = {
  list: async (req, res, next) => {
    try {
      ...
      const result = await departmentUtil.listDepartment(request, next);
  ...
  create: async (req, res, next) => {
    try {
      ...
      const result = await departmentUtil.createDepartment(request, next);
  ...
  update: async (req, res, next) => {
    try {
      ...
      const result = await departmentUtil.updateDepartment(request, next);
  ...
  delete: async (req, res, next) => {
    try {
      ...
      const result = await departmentUtil.deleteDepartment(request, next);
  ...
  listUsersWithDepartment: async (req, res, next) => {
    try {
      ...
      const result = await departmentUtil.listUsersWithDepartment(
        request,
        next
      );
      if (isEmpty(result) || res.headersSent) {
  ...
  listAvailableUsersForDepartment: async (req, res, next) => {
    try {
      ...
      const result = await departmentUtil.listAvailableUsersForDepartment(
        request,
        next
      );
  ...
  assignUserToDepartment: async (req, res, next) => {
    try {
      ...
      const result = await departmentUtil.assignUserToDepartment(request, next);
      if (isEmpty(result) || res.headersSent) {
        return;
      }
      if (result.success === true) {
  ...
  unAssignUserFromDepartment: async (req, res, next) => {
    try {
      ...
      const result = await departmentUtil.unAssignUserFromDepartment(
        request,
        next
      );
      if (isEmpty(result) || res.headersSent) {
