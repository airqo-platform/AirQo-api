...
const createUser = {
  ...
  reSubscribeToNewsLetter: async (req, res, next) => {
    try {
      ...
      const result = await createUserUtil.reSubscribeToNewsLetter(
        request,
        next
      );
  ...
  unSubscribeFromNewsLetter: async (req, res, next) => {
    try {
      ...
      const result = await createUserUtil.unSubscribeFromNewsLetter(
        request,
        next
      );
  ...
  subscribeToNotifications: async (req, res, next) => {
    try {
      ...
      const result = await createUserUtil.subscribeToNotifications(
        request,
        next
      );
  ...
  unSubscribeFromNotifications: async (req, res, next) => {
    try {
      ...
      const result = await createUserUtil.unSubscribeFromNotifications(
        request,
        next
      );
  ...
  checkNotificationStatus: async (req, res, next) => {
    try {
      ...
      const result = await createUserUtil.checkNotificationStatus(
        request,
        next
      );
