...
const createNetwork = {
  getNetworkFromEmail: async (req, res, next) => {
    try {
      ...
      const result = await networkUtil.getNetworkFromEmail(request, next);
  ...
  assignUsers: async (req, res, next) => {
    try {
      ...
      const result = await networkUtil.assignUsersHybrid(request, next);
  ...
  assignOneUser: async (req, res, next) => {
    try {
      ...
      const result = await networkUtil.assignOneUser(request, next);
      if (isEmpty(result) || res.headersSent) {
        return;
      }
  ...
  unAssignUser: async (req, res, next) => {
    try {
      ...
      const result = await networkUtil.unAssignUser(request, next);
  ...
  unAssignManyUsers: async (req, res, next) => {
    try {
      ...
      const result = await networkUtil.unAssignManyUsers(request, next);
  ...
  setManager: async (req, res, next) => {
    try {
      ...
      const result = await networkUtil.setManager(request, next);
      if (isEmpty(result) || res.headersSent) {
        return;
      }
  ...
  update: async (req, res, next) => {
    try {
      ...
      const result = await networkUtil.update(request, next);
  ...
  refresh: async (req, res, next) => {
    try {
      ...
      const result = await networkUtil.refresh(request, next);
  ...
  delete: async (req, res, next) => {
    try {
      ...
      const result = await networkUtil.delete(request, next);
  ...
  listRolesForNetwork: async (req, res, next) => {
    try {
      ...
      const result = await rolePermissionsUtil.listRolesForNetwork(
        request,
        next
      );
  ...
  listAssignedUsers: async (req, res, next) => {
    try {
      ...
      const result = await networkUtil.listAssignedUsers(request, next);
  ...
  listAvailableUsers: async (req, res, next) => {
    try {
      ...
      const result = await networkUtil.listAvailableUsers(request, next);
