...
const createAccessRequest = {
  requestAccessToGroup: async (req, res, next) => {
    try {
      ...
      const result = await requestUtil.requestAccessToGroup(request, next);
  ...
  requestAccessToNetwork: async (req, res, next) => {
    try {
      ...
      const result = await requestUtil.requestAccessToNetwork(request, next);
  ...
  approveAccessRequest: async (req, res, next) => {
    try {
      ...
      const result = await requestUtil.approveAccessRequest(request, next);
  ...
  delete: async (req, res, next) => {
    try {
      ...
      const result = await requestUtil.delete(request, next);
  ...
  listPendingInvitationsForUser: async (req, res, next) => {
    try {
      const errors = extractErrorsFromRequest(req);
      if (errors) {
        next(
      ...
      const result = await requestUtil.listPendingInvitationsForUser(
        request,
        next,
      );
  ...
  acceptPendingInvitation: async (req, res, next) => {
    try {
      const errors = extractErrorsFromRequest(req);
      if (errors) {
        next(
  ...
  rejectPendingInvitation: async (req, res, next) => {
    try {
      const errors = extractErrorsFromRequest(req);
      if (errors) {
        next(
