...
const groupController = {
  ...
  create: (req, res, next) =>
    executeGroupAction(req, res, next, groupUtil.create),

  update: (req, res, next) =>
    executeGroupAction(req, res, next, groupUtil.update),

  delete: (req, res, next) =>
    executeGroupAction(req, res, next, groupUtil.delete),

  assignUsers: (req, res, next) =>
    executeGroupAction(req, res, next, groupUtil.assignUsersHybrid),

  assignOneUser: (req, res, next) =>
    executeGroupAction(req, res, next, groupUtil.assignOneUser),

  unAssignUser: (req, res, next) =>
    executeGroupAction(req, res, next, groupUtil.unAssignUser),

  unAssignManyUsers: (req, res, next) =>
    executeGroupAction(req, res, next, groupUtil.unAssignManyUsers),
  ...
  assignMemberRole: (req, res, next) =>
    executeGroupAction(req, res, next, groupUtil.assignMemberRole),
