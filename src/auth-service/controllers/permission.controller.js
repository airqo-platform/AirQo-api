...
const createPermission = {
  create: async (req, res, next) => {
    try {
      ...
      const result = await rolePermissionsUtil.createPermission(request, next);
  ...
  list: async (req, res, next) => {
    try {
      ...
      request.query.tenant = isEmpty(req.query.tenant)
        ? defaultTenant
        : req.query.tenant;
      const result = await rolePermissionsUtil.listPermission(request, next);
  ...
  delete: async (req, res, next) => {
    try {
      ...
      const result = await rolePermissionsUtil.deletePermission(request, next);
  ...
  update: async (req, res, next) => {
    try {
      ...
      const result = await rolePermissionsUtil.updatePermission(request, next);
