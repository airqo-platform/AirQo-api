...
const checklists = {
  update: async (req, res, next) => {
    try {
      ...
      const result = await checklistUtil.update(request, next);
  ...
  create: async (req, res, next) => {
    try {
      ...
      const result = await checklistUtil.create(request, next);
  ...
  upsert: async (req, res, next) => {
    try {
      ...
      const result = await checklistUtil.upsert(request, next);
  ...
  list: async (req, res, next) => {
    try {
      ...
      const result = await checklistUtil.list(request, next);
  ...
  delete: async (req, res, next) => {
    try {
      ...
      const result = await checklistUtil.delete(request, next);
