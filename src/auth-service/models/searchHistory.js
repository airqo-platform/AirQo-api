...
SearchHistorySchema.index({ firebase_user_id: 1, date_time: 1 }, { unique: true });
...
SearchHistorySchema.statics = {
        ...
        try {
            ...
            if (!isEmpty(data)) {
                ...
                return {
                    success: true,
                    data: [],
                    message: "operation successful but Search History NOT successfully created",
    ...
    async list({ skip = 0, limit = 100, filter = {} } = {}) {
        try {
            const inclusionProjection = constants.SEARCH_HISTORIES_INCLUSION_PROJECTION;
            const exclusionProjection = constants.SEARCH_HISTORIES_EXCLUSION_PROJECTION(
        ...
        try {
            ...
            if (!isEmpty(updatedSearchHistory)) {
                ...
                return {
                    ...
                    errors: { message: "Search History does not exist, please crosscheck" },
