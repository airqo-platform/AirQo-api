...
def calibrate_tool():
    ...
    if not ("datetime" in form_keys and "pm2_5" in form_keys and "s2_pm2_5" in form_keys and "pm10" in form_keys
            and map_columns.get("s2_pm10", None) and "humidity" in form_keys and map_columns.get("temperature", None)):
