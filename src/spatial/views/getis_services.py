...
class SpatialDataHandler:
    ...
    def get_air_quality_data():
        try:
            ...
            significant_hot_spots_geojson = convert_dataframe_to_geojson(
                significant_hot_spots_df
            )
            significant_cold_spots_geojson = convert_dataframe_to_geojson(
                significant_cold_spots_df
            )
