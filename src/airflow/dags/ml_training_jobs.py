...
def train_forecasting_models():
    ...
    def fetch_training_data_for_daily_forecast_model():
        return BigQueryApi().fetch_training_data_forecast_model(months_of_data=configuration.DAILY_FORECAST_TRAINING_JOB_SCOPE)
    ...
    preprocessed_hourly_data = preprocess_training_data_for_hourly_forecast_model(hourly_data)
    hourly_data = feature_engineer_training_data_for_hourly_forecast_model(preprocessed_hourly_data)
    ...
    preprocessed_daily_data = preprocess_training_data_for_daily_forecast_model(daily_data)
