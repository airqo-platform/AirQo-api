...
class BigQueryApi:
    def __init__(self):
        ...
        self.bam_hourly_measurements_table = configuration.BIGQUERY_BAM_HOURLY_EVENTS_TABLE
    ...
    def get_columns(self, table: str, data_type: DataType = DataType.NONE) -> list:
        ...
        elif table == self.bam_measurements_table or table == self.bam_hourly_measurements_table:
