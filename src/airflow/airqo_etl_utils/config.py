...
class Config:
    ...
    BIGQUERY_CLEANED_RAW_MOBILE_EVENTS_TABLE = os.getenv(
        "BIGQUERY_CLEANED_RAW_MOBILE_EVENTS_TABLE"
    )
    BIGQUERY_UNCLEANED_RAW_MOBILE_EVENTS_TABLE = os.getenv(
        "BIGQUERY_UNCLEANED_RAW_MOBILE_EVENTS_TABLE"
    )
