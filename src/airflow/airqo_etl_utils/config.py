...
class Config:
    ...
    BIGQUERY_HOURLY_FORECAST_EVENTS_TABLE = os.getenv("BIGQUERY_HOURLY_FORECAST_EVENTS_TABLE")
    BIGQUERY_DAILY_FORECAST_EVENTS_TABLE = os.getenv('BIGQUERY_DAILY_FORECAST_EVENTS_TABLE')
    ...
    HOURLY_FORECAST_PREDICTION_JOB_SCOPE = os.getenv("HOURLY_FORECAST_PREDICTION_JOB_SCOPE")
    DAILY_FORECAST_PREDICTION_JOB_SCOPE = os.getenv("DAILY_FORECAST_PREDICTION_JOB_SCOPE")
    HOURLY_FORECAST_HORIZON= os.getenv("FORECAST_HOURLY_HORIZON")
    DAILY_FORECAST_HORIZON = os.getenv("FORECAST_DAILY_HORIZON")
