...
class DateUtils:
    ...
    @staticmethod
    def get_dag_date_time_values(historical: bool = False, days: int = None, hours: int = None, **kwargs,):
        try:
            is_manual_run = kwargs["dag_run"].external_trigger if "dag_run" in kwargs else False
