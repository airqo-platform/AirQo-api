...
# Web Server Settings
ENABLE_PROXY_FIX = env.bool("SUPERSET_WEBSERVER_ENABLE_PROXY_FIX", default=True)
TALISMAN_ENABLED = env.bool("TALISMAN_ENABLED", default=True)
...
CONTENT_SECURITY_POLICY_WARNING = env.bool(
    "CONTENT_SECURITY_POLICY_WARNING", default=False
)
