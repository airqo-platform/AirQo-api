...
void main() {
  group('AirQO Icons Flutter Tests', () {
    testWidgets('AqActivity icon renders correctly', (WidgetTester tester) async {
    ...
    testWidgets('AqActivity renders with custom size and color', (WidgetTester tester) async {
    ...
    testWidgets('Icons have proper default values', (WidgetTester tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: Scaffold(
            body: AqActivity(),
    ...
    testWidgets('Multiple icons can be rendered together', (WidgetTester tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: Scaffold(
            body: Column(
    ...
    testWidgets('Icon widget is a StatelessWidget', (WidgetTester tester) async {
    ...
    testWidgets('Package version is accessible', (WidgetTester tester) async {
      expect(AirQOIconsVersion.generated, isNotEmpty);
      expect(AirQOIconsVersion.generated, isA<String>());
    });
  });
}
