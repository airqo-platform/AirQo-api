...
- 2fb5abc: **Enhancements:**
  ...
  **Quality:**
  ...
  No breaking changes. This patch improves package quality and documentation for users and maintainers.

## 0.2.4

### Patch Changes

- Enhanced package metadata and repository information
- Improved package description for better discoverability
- Added additional keywords for npm search optimization
- Updated repository field with proper directory structure
- Enhanced package quality and documentation standards
- Better semantic versioning approach for future releases

## 0.2.3

### Patch Changes

- ac84288: Refactored code, improved documentation, and updated dependencies for @airqo/icons-react. Enhanced icon search and usability features. No breaking changes.
  update
...
- 35c6a40: docs: Clarified fuse.js is only required for advanced search utilities in React package. Updated README to make installation instructions more professional and user-friendly, preventing confusion for users who only want to use icons.

## 0.2.1

### Patch Changes

- 34a1167: docs: Clarified fuse.js is only required for advanced search utilities in React package. Updated README to make installation instructions more professional and user-friendly, preventing confusion for users who only want to use icons.
...
- e4a379a: Minor Update the package documentations
...
- [`6669ac9`](https://github.com/airqo-platform/airqo-libraries/commit/6669ac9d5fa001c94f57703d23341a453f5c8a96) Thanks [@OchiengPaul442](https://github.com/OchiengPaul442)! - Initial release of AirQO Icons React package
  ...
  - 🎨 Customizable with className, size, and color props
  - 📱 React 18+ compatible with SSR support
  ...
  - **Communication**: 58 messaging and social icons
  - **Development**: 57 coding and developer tools icons
  - **Editor**: 104 text editing and formatting icons
  - **Education**: 31 learning and academic icons
  - **Files**: 58 document and file type icons
  - **Finance**: 79 money and e-commerce icons
  - **Maps & Travel**: 42 location and navigation icons
  - **Media & Devices**: 108 multimedia and hardware icons
  - **Security**: 36 privacy and protection icons
  - **Shapes**: 25 geometric and design shapes
  - **Time**: 28 calendar and clock icons
  - **Users**: 41 people and profile icons
  - **Weather**: 52 climate and environmental icons
  - **Alerts & Feedback**: 26 notification and status icons
  - **Arrows**: 92 directional and navigation arrows
  - **Images**: 29 picture and visual media icons
  - **Layout**: 63 structure and positioning icons
