...
class Config:
    ...
    FAULT_DETECTION_TRAINING_LOOKBACK_DAYS = int(
        os.getenv("FAULT_DETECTION_TRAINING_LOOKBACK_DAYS", "90")
    )
    FAULT_DETECTION_TRAINING_DEVICE_LIMIT = int(
        os.getenv("FAULT_DETECTION_TRAINING_DEVICE_LIMIT", "50")
    )
    FAULT_DETECTION_TRAINING_MIN_HOURLY_RECORDS = int(
        os.getenv("FAULT_DETECTION_TRAINING_MIN_HOURLY_RECORDS", "48")
    )
    FAULT_DETECTION_MODELS_BUCKET = os.getenv("FAULT_DETECTION_MODELS_BUCKET")
    FAULT_DETECTION_MODEL_PATH = os.getenv("FAULT_DETECTION_MODEL_PATH")
    FAULT_DETECTION_MLFLOW_EXPERIMENT = os.getenv("FAULT_DETECTION_MLFLOW_EXPERIMENT")
