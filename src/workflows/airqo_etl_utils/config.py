...
class Config:
    ...
    SITE_HOURLY_FORECAST_TRAINING_JOB_SCOPE_MONTHS = os.getenv(
        "SITE_HOURLY_FORECAST_TRAINING_JOB_SCOPE_MONTHS", "3"
    )
    SITE_HOURLY_FORECAST_HORIZON_DAYS = os.getenv(
        "SITE_HOURLY_FORECAST_HORIZON_DAYS", "10"
    )
    ...
    MLFLOW_SITE_HOURLY_FORECAST_EXPERIMENT_NAME = os.getenv(
        "MLFLOW_SITE_HOURLY_FORECAST_EXPERIMENT_NAME"
    )
