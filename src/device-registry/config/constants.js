...
const defaultConfig = {
  ...
  AIRQO_RAW_MEASUREMENTS_TOPIC: process.env.AIRQO_RAW_MEASUREMENTS_TOPIC,
  AIRQO_CALIBRATED_MEASUREMENTS_TOPIC: process.env.AIRQO_CALIBRATED_MEASUREMENTS_TOPIC,
  KCCA_RAW_MEASUREMENTS_TOPIC: process.env.KCCA_RAW_MEASUREMENTS_TOPIC,
  SITE_DISTANCES_TOPIC: process.env.SITE_DISTANCES_TOPIC,
  COMPUTE_SITE_DISTANCES: process.env.COMPUTE_SITE_DISTANCES,
