...
const getConfig = (version, deviceId) => {
    ...
    const options = {
        ...
        headers: {
            authorization: `Bearer ${bridge.createJwt(process.env.PROJECT_ID, privateKeyFile, constants.ALGORITHM)}`,
...
module.exports = { getConfig: getConfig, updateConfig: updateConfig, reviewConfig: reviewConfig };
