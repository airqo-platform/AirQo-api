...
const { date } = require("@utils/common");
...
describe("date", () => {
  describe("generateDateFormat", () => {
    it("should generate date format with hours", () => {
      ...
      const result = date.generateDateFormat(ISODate);
  ...
  describe("generateDateFormatWithoutHrs", () => {
    it("should generate date format without hours", () => {
      ...
      const result = date.generateDateFormatWithoutHrs(ISODate);
  ...
  describe("addMonthsToProvideDateTime", () => {
    it("should add months to the provided date with time", () => {
      ...
      const result = date.addMonthsToProvideDateTime(dateTime, number);
  ...
  describe("isTimeEmpty", () => {
    it("should return false when time is not empty", () => {
      ...
      const result = date.isTimeEmpty(dateTime);
    ...
    it("should return true when time is empty", () => {
      ...
      const result = date.isTimeEmpty(dateOnly);
    ...
    it("should handle invalid input and log error", () => {
      ...
      const result = date.isTimeEmpty(invalidDateTime);
  ...
  describe("formatDate", () => {
    it("should format the date to ISO string", () => {
      ...
      const result = date.formatDate(dateTime);
    ...
    it("should handle invalid input and log error", () => {
      ...
      const result = date.formatDate(invalidDateTime);
  ...
  describe("addMonthsToProvidedDate", () => {
    it("should add months to the provided date", () => {
      ...
      const result = date.addMonthsToProvidedDate(inputDate, monthsToAdd);
    ...
    it("should handle invalid input and log error", () => {
      ...
      const result = date.addMonthsToProvidedDate(invalidDate, monthsToAdd);
  ...
  describe("monthsInfront", () => {
    it("should return a date that is `number` months in front of the current date", () => {
      ...
      const result = date.monthsInfront(monthsToAdd);
    ...
    it("should handle invalid input and log error", () => {
      ...
      const result = date.monthsInfront(invalidNumber);
  ...
  describe("addDays", () => {
    it("should return a date that is `number` days ahead of the current date", () => {
      ...
      const result = date.addDays(daysToAdd);
    ...
    it("should handle invalid input and log error", () => {
      ...
      const result = date.addDays(invalidNumber);
  ...
  describe("addHours", () => {
    it("should return a date that is `number` hours ahead of the current date", () => {
      ...
      const result = date.addHours(hoursToAdd);
    ...
    it("should handle invalid input and log error", () => {
      ...
      const result = date.addHours(invalidNumber);
  ...
  describe("addMinutes", () => {
    it("should return a date that is `number` minutes ahead of the current date", () => {
      ...
      const result = date.addMinutes(minutesToAdd);
    ...
    it("should handle invalid input and log error", () => {
      ...
      const result = date.addMinutes(invalidNumber);
  ...
  describe("getDifferenceInMonths", () => {
    it("should return the difference in months between two dates", () => {
      ...
      const result = date.getDifferenceInMonths(date1, date2);
  ...
  describe("threeMonthsFromNow", () => {
    it("should return a date three months from the provided date", () => {
      ...
      const result = date.threeMonthsFromNow(date);
