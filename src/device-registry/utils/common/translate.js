    ...
    try {
      ...
      for (const lesson of lessons) {
        ...
        if (
          translation &&
          translation.title &&
          translation.completion_message &&
          translation.tasks
        ) {
      ...
      translatedTips = [
        {
          title: "Buli Omu",
          description:
            "Bw’oba olina okumala ebiseera bingi ebweru, masiki ezikozesebwa omulundi gumu nga N95 ziyamba.",
        },
        {
          title: "Buli Omu",
          description:
            "Kendeeza ku maanyi g’emirimu gyo egy’ebweru. Gezaako okubeera mu nnyumba okutuusa ng’omutindo gw’empewo gutereede.",
        },
        {
          title: "Buli Omu",
          description:
            "Weewale emirimu egikuleetera okussa amangu. Leero lwe lunaku olutuufu okumala mu nnyumba ng’osoma.",
        },
        {
          title: "Ku Baana",
        ...
        },
        {
          ...
          description:
            "Kendeeza ku maanyi g’emirimu gyo egy’ebweru okusobola okukuuma ggwe n’omwana wo nga muli balamu bulungi.",
        },
        {
          title: "Ku bantu abalina ensonga z’okussa",
          description:
            "Kendeeza ku dduyiro ow’amaanyi. Kendeeza singa ofuna obubonero ng’okukolola.",
        },
        {
          title: "Ku bakadde",
          description: "Kendeeza ku maanyi g’emirimu gyo egy’ebweru.",
        ...
        },
        {
          title: "Buli Omu",
          description:
            "Leero lunaku lulungi nnyo olw’okukola emirimu egy’ebweru.",
        },
        {
          title: "Buli Omu",
          description:
            "Lunaku lulungi nnyo okufuluma ebweru n'okola dduyiro. Jjukira okukendeeza ku ngendo z’emmotoka z’okola.",
        },
      ];
      break;
    case "pcm":
      translatedTips = [
        {
          title: "For Everybody",
          description:
            "If you wan spend plenty time outside, face mask wey dem fit throway like N95 go help well well.",
        },
        {
          title: "For Everybody",
          description:
            "Make you reduce how you dey waka outside. Try stay inside house until the air quality don better.",
        },
        {
          title: "For Everybody",
          description:
            "No do activity wey go make you dey breathe fast. Today na correct day to stay inside house read book.",
        },
        {
          title: "For Children",
        ...
        },
        {
          ...
          description:
            "Reduce how you dey waka outside to keep you and your baby healthy.",
        },
        {
          title: "For People Wey Get Breathing Wahala",
          description:
            "No do exercise wey go stress you. Relax if you dey experience signs like cough.",
        },
        {
          title: "For Old People",
          description: "Reduce how you dey waka outside.",
        ...
        },
        {
          title: "For Everybody",
          description:
            "Today good to go outside do exercise. Remember to reduce how you dey use motor.",
        },
      ];
      break;
      ...
      translatedLessons = [
        {
          ...
          completion_message:
            "Waakamaliriza Omusomo gwo ogusooka ogwa Manya Empewo Yo",
          tasks: [
            {
              title: "Kozesa entambula ey’olukale",
              content:
                "Omukka ogufuluma mu mmotoka gwe gusinga okuleeta obucaafu bw’empewo. Emmotoka weziba entono ku luguudo zivaamu omukka omutono.",
            },
            {
              title: "Saaviisi emmotoka yo /boda boda buli kiseera",
              content:
                "Ojikebera buli kiseera kisobola okukendeeza ku mafuta, ekikendeeza ku bucaafu obufuluma mu mmotoka.",
            },
            {
              title:
                "Weewale okusiba yingini y’emmotoka yo mu kalippagano k’ebidduka",
              content:
                "Mmotoka zifulumya omukka naddala ogutali mulamu. Ggyako yingini yo ng’oli mu kalippagano k’ebidduka",
            },
            {
              title: "Tambula oba kozesa obugaali",
              content:
                "Tambula oba kozesa obugaali okukendeeza ku kaboni wo ssekinnoomu ate ng’olongoosa n’obulamu bwo!",
            },
            {
              title: "Weewale okwokya kasasiro",
              content:
                "Okwokya kasasiro w’awaka kyabulabe eri obulamu bwo n’obutonde bwaffe",
            },
            {
              title: "Mukendeeze ku biveera ebikozesebwa omulundi gumu",
              content:
                "Weewale okukozesa obuveera, butwala ekiseera kiwanvu okuvunda. Kozesa ensawo z’empapula oba ebisero by’ogula",
            },
            {
              title: "Fuuka nnantameggwa w’empewo ennyonjo",
              content:
                "Weegatte ku kampeyini yaffe ey'omutindo gw'empewo era olwanirire empewo ennongoofu mu kitundu kyo",
            },
          ],
        },
      ];
          ...
          tasks: [
            {
              ...
              content:
                "Motor exhaust na big source of air pollution. Less motor for road go reduce emissions.",
            },
            {
              title: "Service your car/boda boda regularly",
              content:
                "Regular checkup fit maximize fuel efficiency, wey go reduce motor emissions.",
            },
            {
              title: "No idle your motor engine for traffic",
              content:
                "Motor dey produce bad exhaust. Off your engine when you dey traffic.",
            },
            {
              title: "Waka or ride bicycle",
              content:
                "Waka or ride bicycle go reduce your carbon footprint and e go help your health too!",
            },
            {
              title: "No burn garbage",
              content:
                "To burn your house garbage dey dangerous for your health and the environment.",
            },
            {
              title: "Reduce single-use plastic products",
              content:
                "No dey use plastic bags, dem dey take time to decay. Use paper bags or baskets for your shopping.",
            },
            {
              title: "Become champion for clear air",
              content:
                "Join our air quality campaign and talk for clean air for your community.",
            },
          ],
        },
      ];
      ...
      translatedQuizzes = [
        {
          ...
          description:
            "Twala ekibuuzo kino ekikwata ku bikwetoolodde n'enkola ya buli lunaku okusumulula obukodyo obukukoleddwa ku bubwe bwokka!",
          completion_message:
            "Tukuyozaayoza. Osumuludde ebiragiro ebikwata ku mutindo gw’empewo ebikukwatako okukuwa amaanyi mu lugendo lwo olw’empewo ennyonjo.",
          questions: [
            {
            ...
            },
            {
              ...
              answers: [
                ...
                },
                {
                  ...
                  title:
                    "Njagala okumanya engeri endala ez’okuddukanya kasasiro",
                },
              ],
            },
            {
            ...
            },
            {
              ...
              answers: [
                ...
                },
                {
                  ...
                  title:
                    "Oluguudo/oluguudo oluliko kolaasi nga lulimu enfuufu ntono",
                },
              ],
            },
            {
      ...
      translatedQuizzes = [
        {
          ...
          description:
            "Answer this quiz about your area and daily waka to get customized tips wey fit you!",
          completion_message:
            "Well done! You don unlock personalized air quality tips wey go help you on your clean air journey.",
          questions: [
            {
