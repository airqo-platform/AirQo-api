...
const { generateFilter, translate } = require("@utils/common");
const log4js = require("log4js");
const logger = log4js.getLogger(`${constants.ENVIRONMENT} -- kya-util`);
  ...
  listLesson: async (request, next) => {
    try {
      ...
      if (
        ...
        const translatedLessons = await translate.translateLessons(
  ...
  listQuiz: async (request, next) => {
    try {
      ...
      if (
        ...
        const translatedQuizzes = await translate.translateQuizzes(
