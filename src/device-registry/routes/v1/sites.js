  ...
  oneOf([
    [
      ...
      body("distance_to_nearest_residential_road")
        ...
        .bail()
        .toFloat(),
      body("bearing_to_capital_city")
        .optional()
        .notEmpty()
        .trim()
        .isFloat()
        .withMessage("bearing_to_capital_city must be a number")
        .bail()
        .toFloat(),
      body("distance_to_capital_city")
        .optional()
        .notEmpty()
        .trim()
        .isFloat()
        .withMessage("distance_to_capital_city must be a number")
        .bail()
        .toFloat(),
      body("distance_to_nearest_residential_road")
        .optional()
