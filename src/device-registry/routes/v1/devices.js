  ...
  oneOf([
    [
      body("visibility")
        .optional()
        .notEmpty()
        .withMessage("visibility should not be empty IF provided")
        .bail()
        .trim()
        .isBoolean()
        .withMessage("visibility must be Boolean"),
      ...
      body("mountType")
        .optional()
        .notEmpty()
        .withMessage("mountType should not be empty IF provided")
        .bail()
        .trim()
        .toLowerCase()
        .isIn(["pole", "wall", "faceboard", "rooftop", "suspended"])
      ...
      body("powerType")
        .optional()
        .notEmpty()
        .withMessage("powerType should not be empty IF provided")
        .bail()
        .trim()
        .toLowerCase()
        .isIn(["solar", "mains", "alternator"])
      ...
      body("isRetired")
        .optional()
        .notEmpty()
        .withMessage("isRetired should not be empty IF provided")
        .bail()
        .trim()
        .isBoolean()
        .withMessage("isRetired must be Boolean"),
      body("mobility")
        .optional()
        .notEmpty()
        .withMessage("mobility should not be empty IF provided")
        .bail()
        .trim()
        .isBoolean()
        .withMessage("mobility must be Boolean"),
      body("nextMaintenance")
        .optional()
        .notEmpty()
        .withMessage("nextMaintenance date cannot be empty IF provided")
        .bail()
        .trim()
        .toDate()
        .isISO8601({ strict: true, strictSeparator: true })
      ...
      body("isPrimaryInLocation")
        .optional()
        .notEmpty()
        .withMessage("isPrimaryInLocation should not be empty IF provided")
        .bail()
        .trim()
        .isBoolean()
        .withMessage("isPrimaryInLocation must be Boolean"),
      ...
      body("owner")
        .optional()
        .notEmpty()
        .withMessage("owner should not be empty IF provided")
        .bail()
        .trim()
        .isMongoId()
        .withMessage("the owner must be an object ID")
      ...
      body("elevation")
        .optional()
        .notEmpty()
        .withMessage("elevation should not be empty IF provided")
        .bail()
        .trim()
        .isFloat()
        .withMessage("elevation must be a float")
      ...
      body("writeKey")
        .optional()
        .notEmpty()
        .withMessage("writeKey should not be empty IF provided")
        .bail()
        .trim(),
      body("readKey")
        .optional()
        .notEmpty()
        .withMessage("readKey should not be empty IF provided")
        .bail()
        .trim(),
      body("latitude")
        .optional()
        .notEmpty()
        .withMessage("latitude should not be empty IF provided")
        .bail()
        .trim()
        .matches(constants.LATITUDE_REGEX, "i")
        .withMessage("please provide valid latitude value")
      ...
      body("longitude")
        .optional()
        .notEmpty()
        .withMessage("longitude should not be empty IF provided")
        .bail()
        .trim()
        .matches(constants.LONGITUDE_REGEX, "i")
        .withMessage("please provide valid longitude value")
      ...
      body("product_name")
        .optional()
        .notEmpty()
        .withMessage("product_name should not be empty IF provided")
        .bail()
        .trim(),
      body("device_manufacturer")
        .optional()
        .notEmpty()
        .withMessage("device_manufacturer should not be empty IF provided")
        .bail()
        .trim(),
      body("device_codes")
        .optional()
  ...
  oneOf([
    [
      ...
      body("nextMaintenance")
        .optional()
        .notEmpty()
        .withMessage("nextMaintenance cannot be empty if provided")
        .bail()
        .trim()
        .toDate()
        .isISO8601({ strict: true, strictSeparator: true })
