...
average_bp = Blueprint('exceedance', __name__)


@average_bp.route(api.route['exceedance'], methods=['GET', 'POST', 'PUT', 'DELETE', 'PATCH'])
...
@average_bp.route(api.route['maintenance_logs'], methods=['GET', 'POST', 'PUT', 'DELETE', 'PATCH'])
...
# maintenance log
@average_bp.route(api.route['device_name_maintenance_log'], methods=['GET', 'POST', 'PUT', 'DELETE', 'PATCH'])
...
# maintenance log
@average_bp.route(api.route['device_power'], methods=['GET', 'POST', 'PUT', 'DELETE', 'PATCH'])
...
@average_bp.route(api.route['all_devices_latest_status'], methods=['GET', 'POST', 'PUT', 'DELETE', 'PATCH'])
    ...
    if request.method == 'GET':
        ...
        if documents:
            ...
            response = {'online_devices_percentage': result['online_devices_percentage'],
                        'offline_devices_percentage': result['offline_devices_percentage'], 'created_at': convert_date.convert_GMT_time_to_EAT_local_time(result['created_at'])}
        else:
            response = {
...
@average_bp.route(api.route['devices'], methods=['GET', 'POST', 'PUT', 'DELETE', 'PATCH'])
def get_all_devices():
    '''
    Get all devices latest status
    '''
...
@average_bp.route(api.route['latest_offline_devices'], methods=['GET', 'POST', 'PUT', 'DELETE', 'PATCH'])
...
@average_bp.route(api.route['network_uptime'], methods=['GET', 'POST', 'PUT', 'DELETE', 'PATCH'])
...
@average_bp.route(api.route['best_performing_devices'], methods=['GET', 'POST', 'PUT', 'DELETE', 'PATCH'])
...
@average_bp.route(api.route['worst_performing_devices'], methods=['GET', 'POST', 'PUT', 'DELETE', 'PATCH'])
...
@average_bp.route(api.route['device_uptime'], methods=['GET', 'POST', 'PUT', 'DELETE', 'PATCH'])
...
@average_bp.route(api.route['device_battery_voltage'], methods=['GET', 'POST', 'PUT', 'DELETE', 'PATCH'])
...
@average_bp.route(api.route['device_sensor_correlation'], methods=['GET', 'POST', 'PUT', 'DELETE', 'PATCH'])
...
@average_bp.route(api.route['online_offline'], methods=['GET', 'POST', 'PUT', 'DELETE', 'PATCH'])
