...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('team', '0004_alter_member_picture'),
    ]
    ...
    operations = [
        migrations.AddField(
            model_name='member',
            name='created',
            field=models.DateTimeField(auto_now_add=True, default=datetime.datetime(2024, 11, 26, 16, 44, 18, 484418)),
        ...
        migrations.AddField(
            ...
            name='created',
            field=models.DateTimeField(auto_now_add=True, default=datetime.datetime(2024, 11, 26, 16, 44, 21, 9124)),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='memberbiography',
