...
DEVICE_REGISTRY_STAGING_URL = os.getenv("DEVICE_REGISTRY_STAGING_URL", "https://staging-platform.airqo.net/api/v1/")
DEVICE_REGISTRY_PRODUCTION_URL = os.getenv("DEVICE_REGISTRY_PRODUCTION_URL", "https://platform.airqo.net/api/v1/")
