...
public class hdop extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 2757646262851801590L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"hdop\",\"namespace\":\"airqo.models\",\"fields\":[{\"name\":\"value\",\"type\":[\"null\",\"double\"],\"default\":null}]}");
   ...
   */
  public static airqo.models.hdop.Builder newBuilder() {
    return new airqo.models.hdop.Builder();
  }
   ...
   * @return A new hdop RecordBuilder
   */
  public static airqo.models.hdop.Builder newBuilder(airqo.models.hdop.Builder other) {
    if (other == null) {
      return new airqo.models.hdop.Builder();
    } else {
      return new airqo.models.hdop.Builder(other);
    }
  }
   ...
   * @return A new hdop RecordBuilder
   */
  public static airqo.models.hdop.Builder newBuilder(airqo.models.hdop other) {
    if (other == null) {
      return new airqo.models.hdop.Builder();
    } else {
      return new airqo.models.hdop.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<hdop>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(airqo.models.hdop.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(airqo.models.hdop other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.value)) {
        this.value = data().deepCopy(fields()[0].schema(), other.value);
    ...
    /**
      ...
      * @return This builder.
      */
    public airqo.models.hdop.Builder setValue(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public airqo.models.hdop.Builder clearValue() {
      value = null;
