...
public class externalTemperature extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -5760894599861874582L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"externalTemperature\",\"namespace\":\"airqo.models\",\"fields\":[{\"name\":\"value\",\"type\":[\"null\",\"double\"],\"default\":null}]}");
   ...
   */
  public static airqo.models.externalTemperature.Builder newBuilder() {
    return new airqo.models.externalTemperature.Builder();
  }
   ...
   * @return A new externalTemperature RecordBuilder
   */
  public static airqo.models.externalTemperature.Builder newBuilder(airqo.models.externalTemperature.Builder other) {
    if (other == null) {
      return new airqo.models.externalTemperature.Builder();
    } else {
      return new airqo.models.externalTemperature.Builder(other);
    }
  }
   ...
   * @return A new externalTemperature RecordBuilder
   */
  public static airqo.models.externalTemperature.Builder newBuilder(airqo.models.externalTemperature other) {
    if (other == null) {
      return new airqo.models.externalTemperature.Builder();
    } else {
      return new airqo.models.externalTemperature.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<externalTemperature>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(airqo.models.externalTemperature.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(airqo.models.externalTemperature other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.value)) {
        this.value = data().deepCopy(fields()[0].schema(), other.value);
    ...
    /**
      ...
      * @return This builder.
      */
    public airqo.models.externalTemperature.Builder setValue(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public airqo.models.externalTemperature.Builder clearValue() {
      value = null;
