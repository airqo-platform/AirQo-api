...
public class location extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -5283888078437855112L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"location\",\"namespace\":\"airqo.models\",\"fields\":[{\"name\":\"latitude\",\"type\":[\"null\",\"double\"],\"default\":null},{\"name\":\"longitude\",\"type\":[\"null\",\"double\"],\"default\":null}]}");
   ...
   */
  public static airqo.models.location.Builder newBuilder() {
    return new airqo.models.location.Builder();
  }
   ...
   * @return A new location RecordBuilder
   */
  public static airqo.models.location.Builder newBuilder(airqo.models.location.Builder other) {
    if (other == null) {
      return new airqo.models.location.Builder();
    } else {
      return new airqo.models.location.Builder(other);
    }
  }
   ...
   * @return A new location RecordBuilder
   */
  public static airqo.models.location.Builder newBuilder(airqo.models.location other) {
    if (other == null) {
      return new airqo.models.location.Builder();
    } else {
      return new airqo.models.location.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<location>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(airqo.models.location.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(airqo.models.location other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.latitude)) {
        this.latitude = data().deepCopy(fields()[0].schema(), other.latitude);
    ...
    /**
      ...
      * @return This builder.
      */
    public airqo.models.location.Builder setLatitude(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public airqo.models.location.Builder clearLatitude() {
      latitude = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public airqo.models.location.Builder setLongitude(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public airqo.models.location.Builder clearLongitude() {
      longitude = null;
