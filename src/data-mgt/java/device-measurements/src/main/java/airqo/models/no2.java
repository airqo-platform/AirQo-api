...
public class no2 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -9210261973568767812L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"no2\",\"namespace\":\"airqo.models\",\"fields\":[{\"name\":\"value\",\"type\":[\"null\",\"double\"],\"default\":null},{\"name\":\"calibratedValue\",\"type\":[\"null\",\"double\"],\"default\":null},{\"name\":\"uncertaintyValue\",\"type\":[\"null\",\"double\"],\"default\":null},{\"name\":\"standardDeviationValue\",\"type\":[\"null\",\"double\"],\"default\":null}]}");
   ...
   */
  public static airqo.models.no2.Builder newBuilder() {
    return new airqo.models.no2.Builder();
  }
   ...
   * @return A new no2 RecordBuilder
   */
  public static airqo.models.no2.Builder newBuilder(airqo.models.no2.Builder other) {
    if (other == null) {
      return new airqo.models.no2.Builder();
    } else {
      return new airqo.models.no2.Builder(other);
    }
  }
   ...
   * @return A new no2 RecordBuilder
   */
  public static airqo.models.no2.Builder newBuilder(airqo.models.no2 other) {
    if (other == null) {
      return new airqo.models.no2.Builder();
    } else {
      return new airqo.models.no2.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<no2>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(airqo.models.no2.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(airqo.models.no2 other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.value)) {
        this.value = data().deepCopy(fields()[0].schema(), other.value);
    ...
    /**
      ...
      * @return This builder.
      */
    public airqo.models.no2.Builder setValue(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public airqo.models.no2.Builder clearValue() {
      value = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public airqo.models.no2.Builder setCalibratedValue(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public airqo.models.no2.Builder clearCalibratedValue() {
    ...
    /**
      ...
      * @return This builder.
      */
    public airqo.models.no2.Builder setUncertaintyValue(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public airqo.models.no2.Builder clearUncertaintyValue() {
    ...
    /**
      ...
      * @return This builder.
      */
    public airqo.models.no2.Builder setStandardDeviationValue(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public airqo.models.no2.Builder clearStandardDeviationValue() {
