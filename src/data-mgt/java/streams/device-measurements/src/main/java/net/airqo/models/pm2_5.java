...
public class pm2_5 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -5500048802733052430L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"pm2_5\",\"namespace\":\"net.airqo.models\",\"fields\":[{\"name\":\"value\",\"type\":[\"null\",\"double\"]},{\"name\":\"calibratedValue\",\"type\":[\"null\",\"double\"]},{\"name\":\"uncertaintyValue\",\"type\":[\"null\",\"double\"]},{\"name\":\"standardDeviationValue\",\"type\":[\"null\",\"double\"]}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

  private static SpecificData MODEL$ = new SpecificData();

  private static final BinaryMessageEncoder<pm2_5> ENCODER =
      new BinaryMessageEncoder<pm2_5>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<pm2_5> DECODER =
      new BinaryMessageDecoder<pm2_5>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageEncoder instance used by this class.
   * @return the message encoder used by this class
   */
  public static BinaryMessageEncoder<pm2_5> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<pm2_5> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<pm2_5> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<pm2_5>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this pm2_5 to a ByteBuffer.
  ...
  /**
   * Deserializes a pm2_5 from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a pm2_5 instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static pm2_5 fromByteBuffer(
   ...
   */
  public pm2_5(java.lang.Double value, java.lang.Double calibratedValue, java.lang.Double uncertaintyValue, java.lang.Double standardDeviationValue) {
    this.value = value;
  ...
  /**
   * Creates a new pm2_5 RecordBuilder.
   * @return A new pm2_5 RecordBuilder
   */
  public static net.airqo.models.pm2_5.Builder newBuilder() {
    return new net.airqo.models.pm2_5.Builder();
  }

  /**
   * Creates a new pm2_5 RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new pm2_5 RecordBuilder
   */
  public static net.airqo.models.pm2_5.Builder newBuilder(net.airqo.models.pm2_5.Builder other) {
    if (other == null) {
      return new net.airqo.models.pm2_5.Builder();
    } else {
      return new net.airqo.models.pm2_5.Builder(other);
    }
  }

  /**
   * Creates a new pm2_5 RecordBuilder by copying an existing pm2_5 instance.
   * @param other The existing instance to copy.
   * @return A new pm2_5 RecordBuilder
   */
  public static net.airqo.models.pm2_5.Builder newBuilder(net.airqo.models.pm2_5 other) {
    if (other == null) {
      return new net.airqo.models.pm2_5.Builder();
    } else {
      return new net.airqo.models.pm2_5.Builder(other);
  ...
  /**
   * RecordBuilder for pm2_5 instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<pm2_5>
    implements org.apache.avro.data.RecordBuilder<pm2_5> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(net.airqo.models.pm2_5.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing pm2_5 instance
     * @param other The existing instance to copy.
     */
    private Builder(net.airqo.models.pm2_5 other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.value)) {
        this.value = data().deepCopy(fields()[0].schema(), other.value);
    ...
    /**
      ...
      * @return This builder.
      */
    public net.airqo.models.pm2_5.Builder setValue(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.airqo.models.pm2_5.Builder clearValue() {
      value = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.airqo.models.pm2_5.Builder setCalibratedValue(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.airqo.models.pm2_5.Builder clearCalibratedValue() {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.airqo.models.pm2_5.Builder setUncertaintyValue(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.airqo.models.pm2_5.Builder clearUncertaintyValue() {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.airqo.models.pm2_5.Builder setStandardDeviationValue(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.airqo.models.pm2_5.Builder clearStandardDeviationValue() {
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<pm2_5>
    WRITER$ = (org.apache.avro.io.DatumWriter<pm2_5>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<pm2_5>
    READER$ = (org.apache.avro.io.DatumReader<pm2_5>)MODEL$.createDatumReader(SCHEMA$);
