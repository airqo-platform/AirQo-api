...
public class location extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static net.airqo.models.location.Builder newBuilder() {
    return new net.airqo.models.location.Builder();
  }
   ...
   * @return A new location RecordBuilder
   */
  public static net.airqo.models.location.Builder newBuilder(net.airqo.models.location.Builder other) {
    if (other == null) {
      return new net.airqo.models.location.Builder();
    } else {
      return new net.airqo.models.location.Builder(other);
    }
  }
   ...
   * @return A new location RecordBuilder
   */
  public static net.airqo.models.location.Builder newBuilder(net.airqo.models.location other) {
    if (other == null) {
      return new net.airqo.models.location.Builder();
    } else {
      return new net.airqo.models.location.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<location>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(net.airqo.models.location.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(net.airqo.models.location other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.latitude)) {
        this.latitude = data().deepCopy(fields()[0].schema(), other.latitude);
    ...
    /**
      ...
      * @return This builder.
      */
    public net.airqo.models.location.Builder setLatitude(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.airqo.models.location.Builder clearLatitude() {
      latitude = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.airqo.models.location.Builder setLongitude(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.airqo.models.location.Builder clearLongitude() {
      longitude = null;
