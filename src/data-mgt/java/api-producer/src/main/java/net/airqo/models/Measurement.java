...
public class Measurement extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public void put(int field$, Object value$) {
    switch (field$) {
    case 0: frequency = (CharSequence)value$; break;
    case 1: time = (CharSequence)value$; break;
    case 2: device = (CharSequence)value$; break;
    case 3: device_id = (CharSequence)value$; break;
    case 4: site_id = (CharSequence)value$; break;
    case 5: device_number = (Integer)value$; break;
    case 6: tenant = (CharSequence)value$; break;
    case 7: location = (net.airqo.models.location)value$; break;
    case 8: internalTemperature = (net.airqo.models.internalTemperature)value$; break;
    case 9: internalHumidity = (net.airqo.models.internalHumidity)value$; break;
    case 10: externalTemperature = (net.airqo.models.externalTemperature)value$; break;
    case 11: externalHumidity = (net.airqo.models.externalHumidity)value$; break;
    case 12: externalPressure = (net.airqo.models.externalPressure)value$; break;
    case 13: pm10 = (net.airqo.models.pm10)value$; break;
    case 14: pm2_5 = (net.airqo.models.pm2_5)value$; break;
    case 15: no2 = (net.airqo.models.no2)value$; break;
    case 16: pm1 = (net.airqo.models.pm1)value$; break;
    case 17: speed = (net.airqo.models.speed)value$; break;
    case 18: altitude = (net.airqo.models.altitude)value$; break;
    case 19: battery = (net.airqo.models.battery)value$; break;
    case 20: satellites = (net.airqo.models.satellites)value$; break;
    case 21: hdop = (net.airqo.models.hdop)value$; break;
    case 22: s2_pm10 = (net.airqo.models.s2_pm10)value$; break;
    case 23: s2_pm2_5 = (net.airqo.models.s2_pm2_5)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public void setFrequency(CharSequence value) {
   ...
   * @param value the value to set.
   */
  public void setTenant(CharSequence value) {
    this.tenant = value;
  }
   ...
   * @return A new Measurement RecordBuilder
   */
  public static Builder newBuilder(Measurement other) {
    if (other == null) {
      return new Builder();
    } else {
      return new Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Measurement>
     ...
     * @param other The existing instance to copy.
     */
    private Builder(Measurement other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.frequency)) {
        this.frequency = data().deepCopy(fields()[0].schema(), other.frequency);
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setFrequency(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setSiteId(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setDeviceNumber(Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setTenant(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setLocation(net.airqo.models.location value) {
    ...
    public Builder setLocationBuilder(net.airqo.models.location.Builder value) {
      clearLocation();
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setInternalTemperature(net.airqo.models.internalTemperature value) {
    ...
    public Builder setInternalTemperatureBuilder(net.airqo.models.internalTemperature.Builder value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setInternalHumidity(net.airqo.models.internalHumidity value) {
    ...
    public Builder setInternalHumidityBuilder(net.airqo.models.internalHumidity.Builder value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder clearInternalHumidity() {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setExternalTemperature(net.airqo.models.externalTemperature value) {
    ...
    public Builder setExternalTemperatureBuilder(net.airqo.models.externalTemperature.Builder value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setExternalHumidity(net.airqo.models.externalHumidity value) {
    ...
    public Builder setExternalHumidityBuilder(net.airqo.models.externalHumidity.Builder value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder clearExternalHumidity() {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setExternalPressure(net.airqo.models.externalPressure value) {
    ...
    public Builder setExternalPressureBuilder(net.airqo.models.externalPressure.Builder value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder clearExternalPressure() {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setPm10(net.airqo.models.pm10 value) {
    ...
    public Builder setPm10Builder(net.airqo.models.pm10.Builder value) {
      clearPm10();
      pm10Builder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setPm25(net.airqo.models.pm2_5 value) {
    ...
    public Builder setPm25Builder(net.airqo.models.pm2_5.Builder value) {
      clearPm25();
      pm2_5Builder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setNo2(net.airqo.models.no2 value) {
    ...
    public Builder setNo2Builder(net.airqo.models.no2.Builder value) {
      clearNo2();
      no2Builder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setPm1(net.airqo.models.pm1 value) {
    ...
    public Builder setPm1Builder(net.airqo.models.pm1.Builder value) {
      clearPm1();
      pm1Builder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setSpeed(net.airqo.models.speed value) {
    ...
    public Builder setSpeedBuilder(net.airqo.models.speed.Builder value) {
      clearSpeed();
      speedBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setAltitude(net.airqo.models.altitude value) {
    ...
    public Builder setAltitudeBuilder(net.airqo.models.altitude.Builder value) {
      clearAltitude();
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setBattery(net.airqo.models.battery value) {
    ...
    public Builder setBatteryBuilder(net.airqo.models.battery.Builder value) {
      clearBattery();
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setSatellites(net.airqo.models.satellites value) {
    ...
    public Builder setSatellitesBuilder(net.airqo.models.satellites.Builder value) {
      clearSatellites();
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setHdop(net.airqo.models.hdop value) {
    ...
    public Builder setHdopBuilder(net.airqo.models.hdop.Builder value) {
      clearHdop();
      hdopBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setS2Pm10(net.airqo.models.s2_pm10 value) {
    ...
    public Builder setS2Pm10Builder(net.airqo.models.s2_pm10.Builder value) {
      clearS2Pm10();
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setS2Pm25(net.airqo.models.s2_pm2_5 value) {
    ...
    public Builder setS2Pm25Builder(net.airqo.models.s2_pm2_5.Builder value) {
      clearS2Pm25();
    ...
    public Measurement build() {
      try {
        ...
        record.frequency = fieldSetFlags()[0] ? this.frequency : (CharSequence) defaultValue(fields()[0]);
        record.time = fieldSetFlags()[1] ? this.time : (CharSequence) defaultValue(fields()[1]);
        record.device = fieldSetFlags()[2] ? this.device : (CharSequence) defaultValue(fields()[2]);
        record.device_id = fieldSetFlags()[3] ? this.device_id : (CharSequence) defaultValue(fields()[3]);
        record.site_id = fieldSetFlags()[4] ? this.site_id : (CharSequence) defaultValue(fields()[4]);
        record.device_number = fieldSetFlags()[5] ? this.device_number : (Integer) defaultValue(fields()[5]);
        record.tenant = fieldSetFlags()[6] ? this.tenant : (CharSequence) defaultValue(fields()[6]);
        if (locationBuilder != null) {
          try {
          ...
          record.location = fieldSetFlags()[7] ? this.location : (net.airqo.models.location) defaultValue(fields()[7]);
        }
        if (internalTemperatureBuilder != null) {
          try {
          ...
          record.internalTemperature = fieldSetFlags()[8] ? this.internalTemperature : (net.airqo.models.internalTemperature) defaultValue(fields()[8]);
        }
        if (internalHumidityBuilder != null) {
          try {
          ...
          record.internalHumidity = fieldSetFlags()[9] ? this.internalHumidity : (net.airqo.models.internalHumidity) defaultValue(fields()[9]);
        }
        if (externalTemperatureBuilder != null) {
          try {
          ...
          record.externalTemperature = fieldSetFlags()[10] ? this.externalTemperature : (net.airqo.models.externalTemperature) defaultValue(fields()[10]);
        }
        if (externalHumidityBuilder != null) {
          try {
          ...
          record.externalHumidity = fieldSetFlags()[11] ? this.externalHumidity : (net.airqo.models.externalHumidity) defaultValue(fields()[11]);
        }
        if (externalPressureBuilder != null) {
          try {
          ...
          record.externalPressure = fieldSetFlags()[12] ? this.externalPressure : (net.airqo.models.externalPressure) defaultValue(fields()[12]);
        }
        if (pm10Builder != null) {
          try {
          ...
          record.pm10 = fieldSetFlags()[13] ? this.pm10 : (net.airqo.models.pm10) defaultValue(fields()[13]);
        }
        if (pm2_5Builder != null) {
          try {
          ...
          record.pm2_5 = fieldSetFlags()[14] ? this.pm2_5 : (net.airqo.models.pm2_5) defaultValue(fields()[14]);
        }
        if (no2Builder != null) {
          try {
          ...
          record.no2 = fieldSetFlags()[15] ? this.no2 : (net.airqo.models.no2) defaultValue(fields()[15]);
        }
        if (pm1Builder != null) {
          try {
          ...
          record.pm1 = fieldSetFlags()[16] ? this.pm1 : (net.airqo.models.pm1) defaultValue(fields()[16]);
        }
        if (speedBuilder != null) {
          try {
          ...
          record.speed = fieldSetFlags()[17] ? this.speed : (net.airqo.models.speed) defaultValue(fields()[17]);
        }
        if (altitudeBuilder != null) {
          try {
          ...
          record.altitude = fieldSetFlags()[18] ? this.altitude : (net.airqo.models.altitude) defaultValue(fields()[18]);
        }
        if (batteryBuilder != null) {
          try {
          ...
          record.battery = fieldSetFlags()[19] ? this.battery : (net.airqo.models.battery) defaultValue(fields()[19]);
        }
        if (satellitesBuilder != null) {
          try {
          ...
          record.satellites = fieldSetFlags()[20] ? this.satellites : (net.airqo.models.satellites) defaultValue(fields()[20]);
        }
        if (hdopBuilder != null) {
          try {
          ...
          record.hdop = fieldSetFlags()[21] ? this.hdop : (net.airqo.models.hdop) defaultValue(fields()[21]);
        }
        if (s2_pm10Builder != null) {
          try {
          ...
          record.s2_pm10 = fieldSetFlags()[22] ? this.s2_pm10 : (net.airqo.models.s2_pm10) defaultValue(fields()[22]);
        }
        if (s2_pm2_5Builder != null) {
          try {
          ...
          record.s2_pm2_5 = fieldSetFlags()[23] ? this.s2_pm2_5 : (net.airqo.models.s2_pm2_5) defaultValue(fields()[23]);
        }
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (this.internalTemperature == null) {
        this.internalTemperature = new internalTemperature();
      }
      this.internalTemperature.customDecode(in);

      if (this.internalHumidity == null) {
        this.internalHumidity = new internalHumidity();
      }
      ...
      if (this.externalHumidity == null) {
        this.externalHumidity = new externalHumidity();
      }
      this.externalHumidity.customDecode(in);

      if (this.externalPressure == null) {
        this.externalPressure = new externalPressure();
      }
      ...
      if (this.s2_pm10 == null) {
        this.s2_pm10 = new s2_pm10();
      }
      this.s2_pm10.customDecode(in);

      if (this.s2_pm2_5 == null) {
        this.s2_pm2_5 = new s2_pm2_5();
      }
