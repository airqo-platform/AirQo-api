...
public class pm2_5 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public pm2_5(Double value, Double calibratedValue, Double uncertaintyValue, Double standardDeviationValue) {
    this.value = value;
   ...
   * @return A new pm2_5 RecordBuilder
   */
  public static Builder newBuilder(pm2_5 other) {
    if (other == null) {
      return new Builder();
    } else {
      return new Builder(other);
