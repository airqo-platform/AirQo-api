...
public class pm1 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public pm1(Double value, Double calibratedValue, Double uncertaintyValue, Double standardDeviationValue) {
    this.value = value;
   ...
   * @return A new pm1 RecordBuilder
   */
  public static Builder newBuilder(pm1 other) {
    if (other == null) {
      return new Builder();
    } else {
      return new Builder(other);
