...
public class no2 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public no2(Double value, Double calibratedValue, Double uncertaintyValue, Double standardDeviationValue) {
    this.value = value;
   ...
   * @return A new no2 RecordBuilder
   */
  public static Builder newBuilder(no2 other) {
    if (other == null) {
      return new Builder();
    } else {
      return new Builder(other);
