...
public class s2_pm10 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public s2_pm10(Double value, Double calibratedValue, Double uncertaintyValue, Double standardDeviationValue) {
    this.value = value;
   ...
   * @return A new s2_pm10 RecordBuilder
   */
  public static Builder newBuilder(s2_pm10 other) {
    if (other == null) {
      return new Builder();
    } else {
      return new Builder(other);
