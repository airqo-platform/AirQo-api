...
public class s2_pm2_5 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public s2_pm2_5(Double value, Double calibratedValue, Double uncertaintyValue, Double standardDeviationValue) {
    this.value = value;
   ...
   * @return A new s2_pm2_5 RecordBuilder
   */
  public static Builder newBuilder(s2_pm2_5 other) {
    if (other == null) {
      return new Builder();
    } else {
      return new Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<s2_pm2_5>
     ...
     * @param other The existing instance to copy.
     */
    private Builder(s2_pm2_5 other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.value)) {
        this.value = data().deepCopy(fields()[0].schema(), other.value);
