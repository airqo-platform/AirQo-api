...
public class AirqoConnectorConfig extends AbstractConfig {
    ...
    public static final String DEVICES_FETCH_INTERVAL = "devicesFetchInterval";
    ...
    public static final ConfigDef CONFIG_DEF = new ConfigDef()
            ...
            .define(DEVICES_FETCH_INTERVAL, ConfigDef.Type.STRING, ConfigDef.Importance.HIGH, "Devices Fetch Interval")
