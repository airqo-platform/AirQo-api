...
public class internalHumidity extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -3095435234614167366L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"internalHumidity\",\"namespace\":\"airqo.models\",\"fields\":[{\"name\":\"value\",\"type\":[\"null\",\"double\"],\"default\":null}]}");
   ...
   */
  public static airqo.models.internalHumidity.Builder newBuilder() {
    return new airqo.models.internalHumidity.Builder();
  }
   ...
   * @return A new internalHumidity RecordBuilder
   */
  public static airqo.models.internalHumidity.Builder newBuilder(airqo.models.internalHumidity.Builder other) {
    if (other == null) {
      return new airqo.models.internalHumidity.Builder();
    } else {
      return new airqo.models.internalHumidity.Builder(other);
    }
  }
   ...
   * @return A new internalHumidity RecordBuilder
   */
  public static airqo.models.internalHumidity.Builder newBuilder(airqo.models.internalHumidity other) {
    if (other == null) {
      return new airqo.models.internalHumidity.Builder();
    } else {
      return new airqo.models.internalHumidity.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<internalHumidity>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(airqo.models.internalHumidity.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(airqo.models.internalHumidity other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.value)) {
        this.value = data().deepCopy(fields()[0].schema(), other.value);
    ...
    /**
      ...
      * @return This builder.
      */
    public airqo.models.internalHumidity.Builder setValue(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public airqo.models.internalHumidity.Builder clearValue() {
      value = null;
