...
public class battery extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -1913401837114223502L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"battery\",\"namespace\":\"airqo.models\",\"fields\":[{\"name\":\"value\",\"type\":[\"null\",\"double\"],\"default\":null}]}");
   ...
   */
  public static airqo.models.battery.Builder newBuilder() {
    return new airqo.models.battery.Builder();
  }
   ...
   * @return A new battery RecordBuilder
   */
  public static airqo.models.battery.Builder newBuilder(airqo.models.battery.Builder other) {
    if (other == null) {
      return new airqo.models.battery.Builder();
    } else {
      return new airqo.models.battery.Builder(other);
    }
  }
   ...
   * @return A new battery RecordBuilder
   */
  public static airqo.models.battery.Builder newBuilder(airqo.models.battery other) {
    if (other == null) {
      return new airqo.models.battery.Builder();
    } else {
      return new airqo.models.battery.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<battery>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(airqo.models.battery.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(airqo.models.battery other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.value)) {
        this.value = data().deepCopy(fields()[0].schema(), other.value);
    ...
    /**
      ...
      * @return This builder.
      */
    public airqo.models.battery.Builder setValue(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public airqo.models.battery.Builder clearValue() {
      value = null;
