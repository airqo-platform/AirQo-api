...
public class altitude extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 650184928598344364L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"altitude\",\"namespace\":\"airqo.models\",\"fields\":[{\"name\":\"value\",\"type\":[\"null\",\"double\"],\"default\":null}]}");
   ...
   */
  public static airqo.models.altitude.Builder newBuilder() {
    return new airqo.models.altitude.Builder();
  }
   ...
   * @return A new altitude RecordBuilder
   */
  public static airqo.models.altitude.Builder newBuilder(airqo.models.altitude.Builder other) {
    if (other == null) {
      return new airqo.models.altitude.Builder();
    } else {
      return new airqo.models.altitude.Builder(other);
    }
  }
   ...
   * @return A new altitude RecordBuilder
   */
  public static airqo.models.altitude.Builder newBuilder(airqo.models.altitude other) {
    if (other == null) {
      return new airqo.models.altitude.Builder();
    } else {
      return new airqo.models.altitude.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<altitude>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(airqo.models.altitude.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(airqo.models.altitude other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.value)) {
        this.value = data().deepCopy(fields()[0].schema(), other.value);
    ...
    /**
      ...
      * @return This builder.
      */
    public airqo.models.altitude.Builder setValue(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public airqo.models.altitude.Builder clearValue() {
      value = null;
