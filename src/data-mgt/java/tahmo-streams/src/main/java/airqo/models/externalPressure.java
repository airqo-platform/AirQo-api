...
public class externalPressure extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 5556844414107745249L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"externalPressure\",\"namespace\":\"airqo.models\",\"fields\":[{\"name\":\"value\",\"type\":[\"null\",\"double\"],\"default\":null}]}");
   ...
   */
  public static airqo.models.externalPressure.Builder newBuilder() {
    return new airqo.models.externalPressure.Builder();
  }
   ...
   * @return A new externalPressure RecordBuilder
   */
  public static airqo.models.externalPressure.Builder newBuilder(airqo.models.externalPressure.Builder other) {
    if (other == null) {
      return new airqo.models.externalPressure.Builder();
    } else {
      return new airqo.models.externalPressure.Builder(other);
    }
  }
   ...
   * @return A new externalPressure RecordBuilder
   */
  public static airqo.models.externalPressure.Builder newBuilder(airqo.models.externalPressure other) {
    if (other == null) {
      return new airqo.models.externalPressure.Builder();
    } else {
      return new airqo.models.externalPressure.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<externalPressure>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(airqo.models.externalPressure.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(airqo.models.externalPressure other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.value)) {
        this.value = data().deepCopy(fields()[0].schema(), other.value);
    ...
    /**
      ...
      * @return This builder.
      */
    public airqo.models.externalPressure.Builder setValue(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public airqo.models.externalPressure.Builder clearValue() {
      value = null;
