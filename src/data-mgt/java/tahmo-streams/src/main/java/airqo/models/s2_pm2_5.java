...
public class s2_pm2_5 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 6682674876456395558L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"s2_pm2_5\",\"namespace\":\"airqo.models\",\"fields\":[{\"name\":\"value\",\"type\":[\"null\",\"double\"],\"default\":null},{\"name\":\"calibratedValue\",\"type\":[\"null\",\"double\"],\"default\":null},{\"name\":\"uncertaintyValue\",\"type\":[\"null\",\"double\"],\"default\":null},{\"name\":\"standardDeviationValue\",\"type\":[\"null\",\"double\"],\"default\":null}]}");
   ...
   */
  public static airqo.models.s2_pm2_5.Builder newBuilder() {
    return new airqo.models.s2_pm2_5.Builder();
  }
   ...
   * @return A new s2_pm2_5 RecordBuilder
   */
  public static airqo.models.s2_pm2_5.Builder newBuilder(airqo.models.s2_pm2_5.Builder other) {
    if (other == null) {
      return new airqo.models.s2_pm2_5.Builder();
    } else {
      return new airqo.models.s2_pm2_5.Builder(other);
    }
  }
   ...
   * @return A new s2_pm2_5 RecordBuilder
   */
  public static airqo.models.s2_pm2_5.Builder newBuilder(airqo.models.s2_pm2_5 other) {
    if (other == null) {
      return new airqo.models.s2_pm2_5.Builder();
    } else {
      return new airqo.models.s2_pm2_5.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<s2_pm2_5>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(airqo.models.s2_pm2_5.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(airqo.models.s2_pm2_5 other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.value)) {
        this.value = data().deepCopy(fields()[0].schema(), other.value);
    ...
    /**
      ...
      * @return This builder.
      */
    public airqo.models.s2_pm2_5.Builder setValue(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public airqo.models.s2_pm2_5.Builder clearValue() {
      value = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public airqo.models.s2_pm2_5.Builder setCalibratedValue(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public airqo.models.s2_pm2_5.Builder clearCalibratedValue() {
    ...
    /**
      ...
      * @return This builder.
      */
    public airqo.models.s2_pm2_5.Builder setUncertaintyValue(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public airqo.models.s2_pm2_5.Builder clearUncertaintyValue() {
    ...
    /**
      ...
      * @return This builder.
      */
    public airqo.models.s2_pm2_5.Builder setStandardDeviationValue(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public airqo.models.s2_pm2_5.Builder clearStandardDeviationValue() {
