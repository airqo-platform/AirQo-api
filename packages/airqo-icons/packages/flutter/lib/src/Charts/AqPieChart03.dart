...
/// AqPieChart03 icon widget (pie-chart-03.svg)
/// 
/// A customizable SVG icon widget with configurable size and color.
class AqPieChart03 extends StatelessWidget {
  /// Creates a AqPieChart03 icon widget.
  /// 
