...
/// AqPhoneCall02 icon widget (phone-call-02.svg)
/// 
/// A customizable SVG icon widget with configurable size and color.
class AqPhoneCall02 extends StatelessWidget {
  /// Creates a AqPhoneCall02 icon widget.
  /// 
