...
/// AqSend01 icon widget (send-01.svg)
/// 
/// A customizable SVG icon widget with configurable size and color.
class AqSend01 extends StatelessWidget {
  /// Creates a AqSend01 icon widget.
  /// 
