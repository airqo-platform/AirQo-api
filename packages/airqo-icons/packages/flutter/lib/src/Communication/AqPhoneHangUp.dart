...
/// AqPhoneHangUp icon widget (phone-hang-up.svg)
/// 
/// A customizable SVG icon widget with configurable size and color.
class AqPhoneHangUp extends StatelessWidget {
  /// Creates a AqPhoneHangUp icon widget.
  /// 
