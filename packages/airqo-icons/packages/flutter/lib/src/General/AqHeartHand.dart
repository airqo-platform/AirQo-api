...
/// AqHeartHand icon widget (heart-hand.svg)
/// 
/// A customizable SVG icon widget with configurable size and color.
class AqHeartHand extends StatelessWidget {
  /// Creates a AqHeartHand icon widget.
  /// 
