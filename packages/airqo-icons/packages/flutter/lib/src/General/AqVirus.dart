...
/// AqVirus icon widget (virus.svg)
/// 
/// A customizable SVG icon widget with configurable size and color.
class AqVirus extends StatelessWidget {
  /// Creates a AqVirus icon widget.
  /// 
