...
/// AqTool01 icon widget (tool-01.svg)
/// 
/// A customizable SVG icon widget with configurable size and color.
class AqTool01 extends StatelessWidget {
  /// Creates a AqTool01 icon widget.
  /// 
