...
/// AqZapCircle icon widget (zap-circle.svg)
/// 
/// A customizable SVG icon widget with configurable size and color.
class AqZapCircle extends StatelessWidget {
  /// Creates a AqZapCircle icon widget.
  /// 
