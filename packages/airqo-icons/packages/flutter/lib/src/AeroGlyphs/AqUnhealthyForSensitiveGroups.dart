...
/// AqUnhealthyForSensitiveGroups icon widget (Unhealthy-for-Sensitive-Groups.svg)
/// 
/// A customizable SVG icon widget with configurable size and color.
class AqUnhealthyForSensitiveGroups extends StatelessWidget {
  /// Creates a AqUnhealthyForSensitiveGroups icon widget.
  /// 
  /// The [size] parameter controls both width and height of the icon.
  /// The [color] parameter overrides the default icon color.
  /// The [semanticsLabel] parameter provides accessibility support.
  const AqUnhealthyForSensitiveGroups({
    super.key,
    this.size = 24.0,
    this.color,
    this.semanticsLabel,
