...
/// AqCube02 icon widget (cube-02.svg)
/// 
/// A customizable SVG icon widget with configurable size and color.
class AqCube02 extends StatelessWidget {
  /// Creates a AqCube02 icon widget.
  /// 
