...
/// AqCube04 icon widget (cube-04.svg)
/// 
/// A customizable SVG icon widget with configurable size and color.
class AqCube04 extends StatelessWidget {
  /// Creates a AqCube04 icon widget.
  /// 
