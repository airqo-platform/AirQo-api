...
/// AqDice5 icon widget (dice-5.svg)
/// 
/// A customizable SVG icon widget with configurable size and color.
class AqDice5 extends StatelessWidget {
  /// Creates a AqDice5 icon widget.
  /// 
