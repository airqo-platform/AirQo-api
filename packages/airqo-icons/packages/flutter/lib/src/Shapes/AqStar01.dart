...
/// AqStar01 icon widget (star-01.svg)
/// 
/// A customizable SVG icon widget with configurable size and color.
class AqStar01 extends StatelessWidget {
  /// Creates a AqStar01 icon widget.
  /// 
