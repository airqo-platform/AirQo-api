...
/// AqTriangle icon widget (triangle.svg)
/// 
/// A customizable SVG icon widget with configurable size and color.
class AqTriangle extends StatelessWidget {
  /// Creates a AqTriangle icon widget.
  /// 
