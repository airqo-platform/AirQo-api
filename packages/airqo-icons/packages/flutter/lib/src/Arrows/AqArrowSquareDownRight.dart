...
/// AqArrowSquareDownRight icon widget (arrow-square-down-right.svg)
/// 
/// A customizable SVG icon widget with configurable size and color.
class AqArrowSquareDownRight extends StatelessWidget {
  /// Creates a AqArrowSquareDownRight icon widget.
  /// 
  /// The [size] parameter controls both width and height of the icon.
  /// The [color] parameter overrides the default icon color.
  /// The [semanticsLabel] parameter provides accessibility support.
  const AqArrowSquareDownRight({
    super.key,
    this.size = 24.0,
    this.color,
    this.semanticsLabel,
