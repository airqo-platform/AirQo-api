...
/// AqCursorBox icon widget (cursor-box.svg)
/// 
/// A customizable SVG icon widget with configurable size and color.
class AqCursorBox extends StatelessWidget {
  /// Creates a AqCursorBox icon widget.
  /// 
