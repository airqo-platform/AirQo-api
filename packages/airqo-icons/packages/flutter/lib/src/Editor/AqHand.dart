...
/// AqHand icon widget (hand.svg)
/// 
/// A customizable SVG icon widget with configurable size and color.
class AqHand extends StatelessWidget {
  /// Creates a AqHand icon widget.
  /// 
