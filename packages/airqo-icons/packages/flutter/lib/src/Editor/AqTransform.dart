...
/// AqTransform icon widget (transform.svg)
/// 
/// A customizable SVG icon widget with configurable size and color.
class AqTransform extends StatelessWidget {
  /// Creates a AqTransform icon widget.
  /// 
