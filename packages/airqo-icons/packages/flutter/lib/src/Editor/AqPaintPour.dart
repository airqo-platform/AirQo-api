...
/// AqPaintPour icon widget (paint-pour.svg)
/// 
/// A customizable SVG icon widget with configurable size and color.
class AqPaintPour extends StatelessWidget {
  /// Creates a AqPaintPour icon widget.
  /// 
