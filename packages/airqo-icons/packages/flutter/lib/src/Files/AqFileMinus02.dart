...
/// AqFileMinus02 icon widget (file-minus-02.svg)
/// 
/// A customizable SVG icon widget with configurable size and color.
class AqFileMinus02 extends StatelessWidget {
  /// Creates a AqFileMinus02 icon widget.
  /// 
