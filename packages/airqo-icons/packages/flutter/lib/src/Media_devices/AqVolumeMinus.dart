...
/// AqVolumeMinus icon widget (volume-minus.svg)
/// 
/// A customizable SVG icon widget with configurable size and color.
class AqVolumeMinus extends StatelessWidget {
  /// Creates a AqVolumeMinus icon widget.
  /// 
