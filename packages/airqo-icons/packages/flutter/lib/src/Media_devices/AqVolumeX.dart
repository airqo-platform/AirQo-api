...
/// AqVolumeX icon widget (volume-x.svg)
/// 
/// A customizable SVG icon widget with configurable size and color.
class AqVolumeX extends StatelessWidget {
  /// Creates a AqVolumeX icon widget.
  /// 
