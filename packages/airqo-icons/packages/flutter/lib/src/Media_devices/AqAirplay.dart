...
/// AqAirplay icon widget (airplay.svg)
/// 
/// A customizable SVG icon widget with configurable size and color.
class AqAirplay extends StatelessWidget {
  /// Creates a AqAirplay icon widget.
  /// 
