...
/// AqPrinter icon widget (printer.svg)
/// 
/// A customizable SVG icon widget with configurable size and color.
class AqPrinter extends StatelessWidget {
  /// Creates a AqPrinter icon widget.
  /// 
