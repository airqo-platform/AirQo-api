...
/// AqSimcard icon widget (simcard.svg)
/// 
/// A customizable SVG icon widget with configurable size and color.
class AqSimcard extends StatelessWidget {
  /// Creates a AqSimcard icon widget.
  /// 
