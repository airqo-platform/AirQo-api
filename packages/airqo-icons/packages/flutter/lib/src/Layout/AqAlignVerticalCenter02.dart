...
/// AqAlignVerticalCenter02 icon widget (align-vertical-center-02.svg)
/// 
/// A customizable SVG icon widget with configurable size and color.
class AqAlignVerticalCenter02 extends StatelessWidget {
  /// Creates a AqAlignVerticalCenter02 icon widget.
  /// 
  /// The [size] parameter controls both width and height of the icon.
  /// The [color] parameter overrides the default icon color.
  /// The [semanticsLabel] parameter provides accessibility support.
  const AqAlignVerticalCenter02({
    super.key,
    this.size = 24.0,
    this.color,
    this.semanticsLabel,
