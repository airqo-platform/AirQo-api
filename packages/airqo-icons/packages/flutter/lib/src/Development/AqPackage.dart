...
/// AqPackage icon widget (package.svg)
/// 
/// A customizable SVG icon widget with configurable size and color.
class AqPackage extends StatelessWidget {
  /// Creates a AqPackage icon widget.
  /// 
...
<path d="M16.5 9.5L7.5 4.5" stroke="#1C1D20" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>''',
