...
/// AqServer06 icon widget (server-06.svg)
/// 
/// A customizable SVG icon widget with configurable size and color.
class AqServer06 extends StatelessWidget {
  /// Creates a AqServer06 icon widget.
  /// 
