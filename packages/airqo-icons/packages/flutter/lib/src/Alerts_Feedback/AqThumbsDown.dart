...
/// AqThumbsDown icon widget (thumbs-down.svg)
/// 
/// A customizable SVG icon widget with configurable size and color.
class AqThumbsDown extends StatelessWidget {
  /// Creates a AqThumbsDown icon widget.
  /// 
