...
/// AqShieldZap icon widget (shield-zap.svg)
/// 
/// A customizable SVG icon widget with configurable size and color.
class AqShieldZap extends StatelessWidget {
  /// Creates a AqShieldZap icon widget.
  /// 
