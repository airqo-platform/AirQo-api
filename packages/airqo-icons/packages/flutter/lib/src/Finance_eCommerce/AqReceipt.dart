...
/// AqReceipt icon widget (receipt.svg)
/// 
/// A customizable SVG icon widget with configurable size and color.
class AqReceipt extends StatelessWidget {
  /// Creates a AqReceipt icon widget.
  /// 
