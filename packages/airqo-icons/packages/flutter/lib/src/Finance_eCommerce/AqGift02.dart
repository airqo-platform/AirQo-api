...
/// AqGift02 icon widget (gift-02.svg)
/// 
/// A customizable SVG icon widget with configurable size and color.
class AqGift02 extends StatelessWidget {
  /// Creates a AqGift02 icon widget.
  /// 
