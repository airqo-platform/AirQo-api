...
/// AqScales01 icon widget (scales-01.svg)
/// 
/// A customizable SVG icon widget with configurable size and color.
class AqScales01 extends StatelessWidget {
  /// Creates a AqScales01 icon widget.
  /// 
