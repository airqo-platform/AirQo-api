...
/// AqBank icon widget (bank.svg)
/// 
/// A customizable SVG icon widget with configurable size and color.
class AqBank extends StatelessWidget {
  /// Creates a AqBank icon widget.
  /// 
