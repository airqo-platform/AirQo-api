...
/// AqGift01 icon widget (gift-01.svg)
/// 
/// A customizable SVG icon widget with configurable size and color.
class AqGift01 extends StatelessWidget {
  /// Creates a AqGift01 icon widget.
  /// 
