...
/// AqRocket02 icon widget (rocket-02.svg)
/// 
/// A customizable SVG icon widget with configurable size and color.
class AqRocket02 extends StatelessWidget {
  /// Creates a AqRocket02 icon widget.
  /// 
