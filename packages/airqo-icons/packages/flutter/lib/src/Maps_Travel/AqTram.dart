...
/// AqTram icon widget (tram.svg)
/// 
/// A customizable SVG icon widget with configurable size and color.
class AqTram extends StatelessWidget {
  /// Creates a AqTram icon widget.
  /// 
