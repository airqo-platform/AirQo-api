...
/// AqUsers03 icon widget (users-03.svg)
/// 
/// A customizable SVG icon widget with configurable size and color.
class AqUsers03 extends StatelessWidget {
  /// Creates a AqUsers03 icon widget.
  /// 
