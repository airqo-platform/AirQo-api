...
/// AqCameraOff icon widget (camera-off.svg)
/// 
/// A customizable SVG icon widget with configurable size and color.
class AqCameraOff extends StatelessWidget {
  /// Creates a AqCameraOff icon widget.
  /// 
