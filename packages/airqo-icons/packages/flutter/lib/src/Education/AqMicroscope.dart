...
/// AqMicroscope icon widget (microscope.svg)
/// 
/// A customizable SVG icon widget with configurable size and color.
class AqMicroscope extends StatelessWidget {
  /// Creates a AqMicroscope icon widget.
  /// 
