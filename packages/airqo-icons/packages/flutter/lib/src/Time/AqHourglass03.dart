...
/// AqHourglass03 icon widget (hourglass-03.svg)
/// 
/// A customizable SVG icon widget with configurable size and color.
class AqHourglass03 extends StatelessWidget {
  /// Creates a AqHourglass03 icon widget.
  /// 
