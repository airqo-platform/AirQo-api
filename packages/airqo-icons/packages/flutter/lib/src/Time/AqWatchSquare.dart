...
/// AqWatchSquare icon widget (watch-square.svg)
/// 
/// A customizable SVG icon widget with configurable size and color.
class AqWatchSquare extends StatelessWidget {
  /// Creates a AqWatchSquare icon widget.
  /// 
