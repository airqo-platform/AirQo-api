...
# terraform import google_service_account.backend_app_service_account projects/${var.project-id}/serviceAccounts/backend-app-service-account@airqo-250220.iam.gserviceaccount.com
