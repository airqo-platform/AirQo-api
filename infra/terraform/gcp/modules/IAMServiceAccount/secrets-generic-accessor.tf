...
# terraform import google_service_account.secrets_generic_accessor projects/${var.project-id}/serviceAccounts/secrets-generic-accessor@${var.project-id}.iam.gserviceaccount.com
