...
# terraform import google_service_account.infra_setup_account projects/${var.project-id}/serviceAccounts/infra-setup-account@airqo-250220.iam.gserviceaccount.com
