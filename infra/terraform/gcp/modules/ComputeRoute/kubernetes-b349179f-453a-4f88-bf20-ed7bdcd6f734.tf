resource "google_compute_route" "kubernetes_b349179f_453a_4f88_bf20_ed7bdcd6f734" {
  ...
  next_hop_instance = "projects/${var.project-id}/zones/us-central1-a/instances/pipeline-k8s-worker-1"
  priority          = 1000
  project           = var.project-id
}
# terraform import google_compute_route.kubernetes_b349179f_453a_4f88_bf20_ed7bdcd6f734 projects/${var.project-id}/global/routes/kubernetes-b349179f-453a-4f88-bf20-ed7bdcd6f734
