...
# terraform import google_compute_firewall.pipeline_k8s_cluster_allow_internal projects/airqo-250220/global/firewalls/pipeline-k8s-cluster-allow-internal
