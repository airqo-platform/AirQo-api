...
# terraform import google_compute_global_forwarding_rule.stage_cdn_loadbalancer_forwarding_rule_ipv6 projects/${var.project-id}/global/forwardingRules/stage-cdn-loadbalancer-forwarding-rule-ipv6
