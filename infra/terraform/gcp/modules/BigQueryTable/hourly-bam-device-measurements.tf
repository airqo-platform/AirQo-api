...
# terraform import google_bigquery_table.hourly_bam_device_measurements projects/${var.project-id}/datasets/averaged_data/tables/hourly_bam_device_measurements
