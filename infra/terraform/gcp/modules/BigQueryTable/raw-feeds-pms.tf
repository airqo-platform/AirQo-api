resource "google_bigquery_table" "raw_feeds_pms" {
  ...
  table_id   = "raw_feeds_pms"
}
# terraform import google_bigquery_table.raw_feeds_pms projects/${var.project-id}/datasets/thingspeak_testing/tables/raw_feeds_pms
