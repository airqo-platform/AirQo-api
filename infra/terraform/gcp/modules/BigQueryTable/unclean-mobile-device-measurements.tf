...
# terraform import google_bigquery_table.unclean_mobile_device_measurements projects/${var.project-id}/datasets/raw_data/tables/unclean_mobile_device_measurements
