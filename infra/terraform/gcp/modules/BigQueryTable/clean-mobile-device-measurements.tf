resource "google_bigquery_table" "clean_mobile_device_measurements" {
  ...
  table_id   = "clean_mobile_device_measurements"
...
# terraform import google_bigquery_table.clean_mobile_device_measurements projects/${var.project-id}/datasets/raw_data_stage/tables/clean_mobile_device_measurements
