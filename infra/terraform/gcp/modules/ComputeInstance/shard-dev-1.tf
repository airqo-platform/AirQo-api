resource "google_compute_instance" "shard_dev_1" {
  boot_disk {
    ...
    mode   = "READ_WRITE"
    source = "https://www.googleapis.com/compute/v1/projects/${var.project-id}/zones/europe-west1-b/disks/shard-dev-1"
  }
...
# terraform import google_compute_instance.shard_dev_1 projects/${var.project-id}/zones/europe-west1-b/instances/shard-dev-1
