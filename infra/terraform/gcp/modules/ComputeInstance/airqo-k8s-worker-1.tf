resource "google_compute_instance" "airqo_k8s_worker_1" {
  boot_disk {
    ...
    mode   = "READ_WRITE"
    source = "https://www.googleapis.com/compute/v1/projects/${var.project-id}/zones/europe-west1-b/disks/airqo-k8s-worker-1"
  }
...
# terraform import google_compute_instance.airqo_k8s_worker_1 projects/${var.project-id}/zones/europe-west1-b/instances/airqo-k8s-worker-1
