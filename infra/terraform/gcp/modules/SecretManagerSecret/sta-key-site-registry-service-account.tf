...
# terraform import google_secret_manager_secret.sta_key_site_registry_service_account projects/702081712633/secrets/sta-key-site-registry-service-account
