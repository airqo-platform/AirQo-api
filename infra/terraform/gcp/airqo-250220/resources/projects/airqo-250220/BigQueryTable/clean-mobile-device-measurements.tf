...
# terraform import google_bigquery_table.clean_mobile_device_measurements projects/airqo-250220/datasets/raw_data_stage/tables/clean_mobile_device_measurements
