...
# terraform import google_compute_subnetwork.pipeline_k8s_cluster projects/airqo-250220/regions/northamerica-northeast1/subnetworks/pipeline-k8s-cluster
